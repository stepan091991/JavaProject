...
Движок представляет собой простую и расширяемую основу для создания 2D игр.
...
Метод	                          Описание
1. setGameWorld(GameWorld)	        Подключение игрового мира
2. setInputHandler(InputHandler)	Подключение обработчика ввода
3. start()	                        Запуск игрового цикла
4. stop()	                        Остановка игры
...
3. active — активен ли объект
4. sprite — спрайт

Методы:
1. update(InputHandler) — обновление логики
2. draw(Graphics2D) — отрисовка
